...
public class SecureConf extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
        ...
        .logout().logoutUrl("/perform_logout").logoutSuccessUrl("/admin/login")
        ...
        .loginPage("/admin/login") // trang login do mình thiết kế.
        ...
        .failureUrl("/admin/login?login_error=true") // nhập username, password sai thì redirect về trang nào.
        .permitAll();
	}
